...
if(isset($_POST['login'])){
  $aid = $_POST['adminId'];
  $pass = $_POST['pass'];
  $sql = " select * from  `admins` where adminId='$aid' and password='$pass' ";
  $query = mysqli_query($con, $sql);

  $row = mysqli_num_rows($query);
  if ($row == 1) {
    $q = " select * from  `admins` where adminId='$aid' and password='$pass' ";
        ...
        <div class="col-md-4 col-md-offset-4">
          <form id="login" method="POST" class="well" action="">
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Enter Email" name="adminId">
            </div>
            <div class="form-group">
