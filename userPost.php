          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
                  ...
                  ?>
                      ...
                      <td><a class="btn btn-danger btn-sm" href="delete.php?author=<?php echo $res['author']; ?>">Delete</a></td>
                </tr>
            <?php
                    }
                  }
              ...
              <table class="table table-striped table-hover">
                ...
                <tr>
                  ...
                  ?>
                    ...
                    <td><a class="btn btn-danger btn-sm" href="delete.php?posid=<?php echo $res['posid']; ?>">Delete</a></td>
                </tr>
              <?php
                  }
              ?>
