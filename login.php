      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4">
          <form id="login" method="POST" class="well" action="">
            ...
            <button class="btn btn-default btn-block" style="background: #013120;" onMouseOver="this.style.backgroundColor='red'" onMouseOut="this.style.backgroundColor='#013120'"><a href="adminLogin.php" style="text-decoration: none; color: #fff;">Admin Login</a></button>
            <button class="btn btn-default btn-block" style="background: #013120;" onMouseOver="this.style.backgroundColor='red'" onMouseOut="this.style.backgroundColor='#013120'"><a href="register.php" style="text-decoration: none; color: #fff;">Sign Up</a></button>
          </form>
        </div>
      </div>
    </div>
